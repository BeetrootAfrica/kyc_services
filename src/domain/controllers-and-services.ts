...
import { BusinessController } from "../controllers/businesss-controller/business-controller";
...
let _businessService:BusinessService;
...
export function initializeControllers (server:AsklessServer) {
    _controllers = [
        ...
        new BusinessController(params => _businessService = new BusinessService(params)),
...
export function businessService() { return _businessService; }
